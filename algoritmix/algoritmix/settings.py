"""
Django settings for algoritmix project.
...
SECRET_KEY = 'django-insecure-%yiskn&k0t*5l8-p06e@1x(9rsq)2i#@npn9h9ukkn^90r*8ef'
...
WSGI_APPLICATION = 'algoritmix.wsgi.application'
